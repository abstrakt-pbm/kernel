...
bool Cursor::can_move_right() { return pos_x_ + 1 < limit_x_; }

bool Cursor::can_move_left() { return pos_x_ - 1 >= 0; }

bool Cursor::can_move_up() { return pos_y_ - 1 > 0; }

bool Cursor::can_move_down() { return pos_y_ + 1 < limit_y_; }
