...
void add_hypervisor_mapping_to_init_pml4 () { // kernel mapping to pml4
    ...
    for ( i = 0  ; i < need_page_map ; i++ ) {
        ...
        pdpt_for_hypervisor[ pdpt_offset ] = (reinterpret_cast<uint64_t>(&(pd_for_hypervisor[ pd_offset ])) & 0x000FFFFFFFFFF000) | 0x03;
    }

    reinterpret_cast<uint64_t*>(&pml4_table)[pml4_offset] = (reinterpret_cast<uint64_t>(&pdpt_for_hypervisor) & 0x000FFFFFFFFFF000) | 0x03;
